...
namespace BloodPressureTracker.Utils
{
    public static class Constants
    {
        ...
        // Цвета для статусов давления
        public static readonly Color NORMAL_COLOR = Color.FromArgb("#4CAF50");
        public static readonly Color WARNING_COLOR = Color.FromArgb("#FF9800");
        public static readonly Color DANGER_COLOR = Color.FromArgb("#F44336");
        public static readonly Color UNKNOWN_COLOR = Color.FromArgb("#9E9E9E");
    }
}